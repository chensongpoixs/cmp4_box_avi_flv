...
#ifndef _C_API_VIDEO_VIDEO_FRAME_H_
#define _C_API_VIDEO_VIDEO_FRAME_H_
...
#include "libmedia_codec/hdr_metadata.h"
#include "libmedia_codec/video_frame_buffer.h"
...
class RTC_EXPORT VideoFrame {
 public:
  ...
  struct RTC_EXPORT ProcessingTime {
    webrtc::TimeDelta Elapsed() const { return finish - start; }
    webrtc::Timestamp start;
    webrtc::Timestamp finish;
  };
  ...
  class RTC_EXPORT Builder {
   public:
    ...
    Builder& set_packet_infos(libmedia_transfer_protocol::RtpPacketInfos packet_infos);

   private:
    uint16_t id_ = 0;
    rtc::scoped_refptr< VideoFrameBuffer> video_frame_buffer_;
	...
	libmedia_transfer_protocol::RtpPacketInfos packet_infos_;
  };
  ...
  const libmedia_transfer_protocol::RtpPacketInfos& packet_infos() const { return packet_infos_; }
  void set_packet_infos(libmedia_transfer_protocol::RtpPacketInfos value) {

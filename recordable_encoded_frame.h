...
#ifndef _C_API_VIDEO_RECORDABLE_ENCODED_FRAME_H_
#define _C_API_VIDEO_RECORDABLE_ENCODED_FRAME_H_
...
class RecordableEncodedFrame {
 public:
  ...
  virtual absl::optional<libmedia_codec::ColorSpace> color_space() const = 0;

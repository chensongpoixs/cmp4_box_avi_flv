...
#include "libmedia_codec/video_codecs/video_codec_initializer.h"
...
VideoCodec VideoCodecInitializer::VideoEncoderConfigToVideoCodec(
  ...
  video_codec.timing_frame_thresholds = { libmedia_codec::kDefaultTimingFramesDelayMs,
  ...
  switch (video_codec.codecType) {
    ...
    case kVideoCodecVP9: {
      ...
      if (!config.spatial_layers.empty()) {
        ...
        spatial_layers = webrtc::GetSvcConfig(
            video_codec.width, video_codec.height, video_codec.maxFramerate,
  ...
  const absl::optional<webrtc::DataRate> experimental_min_bitrate =
      webrtc::GetExperimentalMinVideoBitrate(static_cast<webrtc::VideoCodecType>(video_codec.codecType));

...
#ifndef _C_API_VIDEO_CODECS_VIDEO_ENCODER_H_
#define _C_API_VIDEO_CODECS_VIDEO_ENCODER_H_
...
#include "libmedia_codec/fec_controller_override.h"
...
class RTC_EXPORT VideoEncoder {
 public:
  ...
  struct RTC_EXPORT RateControlParameters {
    ...
    RateControlParameters(const VideoBitrateAllocation& bitrate,
                          double framerate_fps,
                          webrtc::DataRate bandwidth_allocation);
  ...
  virtual void SetFecControllerOverride(
     libmedia_codec:: FecControllerOverride* fec_controller_override);

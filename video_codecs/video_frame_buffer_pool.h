...
#ifndef _C_COMMON_VIDEO_INCLUDE_VIDEO_FRAME_BUFFER_POOL_H_
#define _C_COMMON_VIDEO_INCLUDE_VIDEO_FRAME_BUFFER_POOL_H_
...
#include "libmedia_codec/nv12_buffer.h"

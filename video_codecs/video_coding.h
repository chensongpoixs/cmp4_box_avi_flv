...
#ifndef _C_MODULES_VIDEO_CODING_INCLUDE_VIDEO_CODING_H_
#define _C_MODULES_VIDEO_CODING_INCLUDE_VIDEO_CODING_H_
...
class VideoCodingModule : public webrtc::Module {
 public:
  // DEPRECATED.
  static VideoCodingModule* Create(webrtc::Clock* clock);
  ...
  virtual int32_t RegisterReceiveCallback(
	  libmedia_codec::VCMReceiveCallback* receiveCallback) = 0;
  ...
  virtual int32_t RegisterFrameTypeCallback(
      libmedia_codec::VCMFrameTypeCallback* frameTypeCallback) = 0;
  ...
  virtual int32_t RegisterPacketRequestCallback(
	  libmedia_codec::VCMPacketRequestCallback* callback) = 0;
  ...
  virtual int32_t IncomingPacket(const uint8_t* incomingPayload,
                                 ...
                                 const libmedia_transfer_protocol::RTPVideoHeader& video_header) = 0;

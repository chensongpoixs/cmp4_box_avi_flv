 ...
 ******************************************************************************/
#include "libmedia_codec/video_codecs/svc/scalability_structure_key_svc.h"
...
libmedia_transfer_protocol::DecodeTargetIndication ScalabilityStructureKeySvc::Dti(
    int sid,
    int tid,
    const LayerFrameConfig& config) {
  if (config.IsKeyframe() || config.Id() == kKey) {
    RTC_DCHECK_EQ(config.TemporalId(), 0);
    return sid < config.SpatialId() ? libmedia_transfer_protocol::DecodeTargetIndication::kNotPresent
                                    : libmedia_transfer_protocol::DecodeTargetIndication::kSwitch;
  }
...
libmedia_transfer_protocol::FrameDependencyStructure ScalabilityStructureL2T1Key::DependencyStructure()
    const {
...
libmedia_transfer_protocol::FrameDependencyStructure ScalabilityStructureL2T2Key::DependencyStructure()
    const {
	libmedia_transfer_protocol::FrameDependencyStructure structure;
...
libmedia_transfer_protocol::FrameDependencyStructure ScalabilityStructureL2T3Key::DependencyStructure()
    const {
	libmedia_transfer_protocol::FrameDependencyStructure structure;
...
libmedia_transfer_protocol::FrameDependencyStructure ScalabilityStructureL3T3Key::DependencyStructure()
    const {
	libmedia_transfer_protocol::FrameDependencyStructure structure;

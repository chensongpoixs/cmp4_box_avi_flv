 ...
 ******************************************************************************/
#include "libmedia_codec/video_codecs/svc/scalability_structure_full_svc.h"
...
libmedia_transfer_protocol::DecodeTargetIndication ScalabilityStructureFullSvc::Dti(
    int sid,
    int tid,
    const LayerFrameConfig& config) {
  if (sid < config.SpatialId() || tid < config.TemporalId()) {
    return libmedia_transfer_protocol::DecodeTargetIndication::kNotPresent;
  }
  if (sid == config.SpatialId()) {
    if (tid == 0) {
      RTC_DCHECK_EQ(config.TemporalId(), 0);
      return libmedia_transfer_protocol::DecodeTargetIndication::kSwitch;
    }
    if (tid == config.TemporalId()) {
      return libmedia_transfer_protocol::DecodeTargetIndication::kDiscardable;
    }
    if (tid > config.TemporalId()) {
  ...
  return libmedia_transfer_protocol::DecodeTargetIndication::kRequired;
}
...
libmedia_transfer_protocol::FrameDependencyStructure ScalabilityStructureL1T2::DependencyStructure() const {
...
libmedia_transfer_protocol::FrameDependencyStructure ScalabilityStructureL1T3::DependencyStructure() const {
	libmedia_transfer_protocol::FrameDependencyStructure structure;
...
libmedia_transfer_protocol::FrameDependencyStructure ScalabilityStructureL2T1::DependencyStructure() const {
	libmedia_transfer_protocol::FrameDependencyStructure structure;
  structure.num_decode_targets = 2;
...
libmedia_transfer_protocol::FrameDependencyStructure ScalabilityStructureL2T2::DependencyStructure() const {
	libmedia_transfer_protocol::FrameDependencyStructure structure;
...
libmedia_transfer_protocol::FrameDependencyStructure ScalabilityStructureL3T1::DependencyStructure() const {
	libmedia_transfer_protocol::FrameDependencyStructure structure;
  structure.num_decode_targets = 3;
...
libmedia_transfer_protocol::FrameDependencyStructure ScalabilityStructureL3T3::DependencyStructure() const {
	libmedia_transfer_protocol::FrameDependencyStructure structure;

 ...
 ******************************************************************************/
#include "libmedia_codec/video_codecs/svc/scalability_structure_l2t2_key_shift.h"
...
namespace {
	...
	libmedia_transfer_protocol::DecodeTargetIndication
...
libmedia_transfer_protocol::FrameDependencyStructure ScalabilityStructureL2T2KeyShift::DependencyStructure()
    const {

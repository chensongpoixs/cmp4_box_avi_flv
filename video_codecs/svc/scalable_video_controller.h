 ...
 ******************************************************************************/
#ifndef _C_MODULES_VIDEO_CODING_SVC_SCALABLE_VIDEO_CONTROLLER_H_
#define _C_MODULES_VIDEO_CODING_SVC_SCALABLE_VIDEO_CONTROLLER_H_
...
class ScalableVideoController {
 public:
  struct StreamLayersConfig {
    ...
    int scaling_factor_num[libmedia_transfer_protocol::DependencyDescriptor::kMaxSpatialIds] = {1, 1, 1, 1};
    int scaling_factor_den[libmedia_transfer_protocol::DependencyDescriptor::kMaxSpatialIds] = {1, 1, 1, 1};
  };
  ...
  virtual libmedia_transfer_protocol::FrameDependencyStructure DependencyStructure() const = 0;

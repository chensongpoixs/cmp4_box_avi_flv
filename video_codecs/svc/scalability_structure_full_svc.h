 ...
 ******************************************************************************/
#ifndef _C_MODULES_VIDEO_CODING_SVC_SCALABILITY_STRUCTURE_FULL_SVC_H_
#define _C_MODULES_VIDEO_CODING_SVC_SCALABILITY_STRUCTURE_FULL_SVC_H_
...
class ScalabilityStructureFullSvc : public ScalableVideoController {
 ...
 private:
  ...
  static libmedia_transfer_protocol::DecodeTargetIndication Dti(int sid,
                                    int tid,

 ...
 ******************************************************************************/
#include "libmedia_codec/video_codecs/svc/scalability_structure_simulcast.h"
...
libmedia_transfer_protocol::FrameDependencyStructure ScalabilityStructureS2T1::DependencyStructure() const {
...
libmedia_transfer_protocol::FrameDependencyStructure ScalabilityStructureS3T3::DependencyStructure() const {
	libmedia_transfer_protocol::FrameDependencyStructure structure;

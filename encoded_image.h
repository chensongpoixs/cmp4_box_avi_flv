...
#ifndef _C_API_VIDEO_ENCODED_IMAGE_H_
#define _C_API_VIDEO_ENCODED_IMAGE_H_
...
class RTC_EXPORT EncodedImage {
 public:
  ...
  const libmedia_codec::ColorSpace* ColorSpace() const {
    return color_space_ ? &*color_space_ : nullptr;
  }
  void SetColorSpace(const absl::optional<libmedia_codec::ColorSpace>& color_space) {
  ...
  const libmedia_transfer_protocol::RtpPacketInfos& PacketInfos() const { return packet_infos_; }
  void SetPacketInfos(libmedia_transfer_protocol::RtpPacketInfos packet_infos) {
 ...
 private:
  ...
  absl::optional<libmedia_codec::ColorSpace> color_space_;

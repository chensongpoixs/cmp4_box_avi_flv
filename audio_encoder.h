...
#ifndef _C_API_AUDIO_CODECS_AUDIO_ENCODER_H_
#define _C_API_AUDIO_CODECS_AUDIO_ENCODER_H_
...
class AudioEncoder {
 public:
  ...
  // overhead.
  virtual absl::optional<std::pair<webrtc::TimeDelta, webrtc::TimeDelta>> GetFrameLengthRange()
      const = 0;
